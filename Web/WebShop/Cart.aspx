<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Cart.aspx.cs" Inherits="WebShop_Cart" Title="Shopping Cart" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td ><img src="~/Images/Site/spacer.gif" width="70" height="1"></td>
      </tr>
      ...
      <tr>
        ...
        <td width="70"><asp:Image ID="ImageSpacer2" runat="server" ImageUrl="~/Images/Site/spacer.gif" Width="70" height="1" BorderWidth="0" /></td>
      </tr>
      <tr>
