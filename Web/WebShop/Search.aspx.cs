...
public partial class WebShop_Search : PageBase
{
    ...
    private void Bind()
    {
        ...
        // Retrieve list of products via Product Facade.
        ProductFacade facade = new ProductFacade();
        GridViewProducts.DataSource = facade.SearchProducts(productName, priceRangeId, SortExpression);
